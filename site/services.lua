		...
		<div class="services-list-wrapper">
			<div class="services-list-item">
				...
				<ul>
					...
					<li><b>Science: </b>Life Science, Earth Science, Physical Science, Chemistry</li>
					<li><b>History: </b>Geography, US History, World History, Civics/Gov</li>
				</ul>
			</div>
			<div class="services-list-item">
				...
				<ul>
					...
					<li><b>Chemistry: </b>Gen Chem I, Gen Chem II</li>
					<li><b>Physics: </b>Physics I, Physics II</li>
					<li><b>Computer Science: </b>Intro to Java Programming, Intro to Python Programming, Intro to C Programming, Intro to Assembly Programming (microcontrollers), Algorithms and Data Structures</li>
				</ul>
			</div>
		</div>
]]
